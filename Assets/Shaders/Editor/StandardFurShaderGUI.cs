...
{
    internal class StandardFurShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent fabricColorText = EditorGUIUtility.TrTextContent("Fabric Color", "Fabric Color");
            public static GUIContent fabricScaleText = EditorGUIUtility.TrTextContent("Fabric Scale", "Fabric Scale");
            public static GUIContent furTextureText = EditorGUIUtility.TrTextContent("Fur Texture", "Fur Texture");
            public static GUIContent gravityText = EditorGUIUtility.TrTextContent("Gravity", "Gravity (xyz: direction, w: strength)");
            public static GUIContent rimColorText = EditorGUIUtility.TrTextContent("Rim Color", "Rim Color");
            public static GUIContent rimPowerText = EditorGUIUtility.TrTextContent("Rim Power", "Rim Power");
            public static GUIContent furShadingText = EditorGUIUtility.TrTextContent("Fur Shading", "Fur Shading");
            public static GUIContent furLengthText = EditorGUIUtility.TrTextContent("Fur Length", "Fur Length");
            ...
            public static string fabricText = "Fabric Settings";
            public static string furText = "Fur Settings";
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            fabricColor = FindProperty("_FabricColor", props);
            fabricScale = FindProperty("_FabricScale", props);
            furTexture = FindProperty("_FurTex", props);
            gravity = FindProperty("_Gravity", props);
            rimColor = FindProperty("_RimColor", props);
            rimPower = FindProperty("_RimPower", props);
            furShading = FindProperty("_FurShading", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.ShaderProperty(fabricColor, Styles.fabricColorText);
                m_MaterialEditor.ShaderProperty(fabricScale, Styles.fabricScaleText);

                GUILayout.Label(Styles.furText, EditorStyles.boldLabel);
                m_MaterialEditor.TexturePropertySingleLine(Styles.furTextureText, furTexture);
                m_MaterialEditor.TextureScaleOffsetProperty(furTexture);
                ...
                m_MaterialEditor.ShaderProperty(furShading, Styles.furShadingText);
