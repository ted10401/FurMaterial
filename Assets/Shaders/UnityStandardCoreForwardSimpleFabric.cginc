...
#ifndef UNITY_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED_FUR
#define UNITY_STANDARD_CORE_FORWARD_SIMPLE_INCLUDED_FUR
...
VertexOutputBaseSimple vertForwardBaseSimpleFur(VertexInput v, half FUR_OFFSET)
{
	UNITY_SETUP_INSTANCE_ID(v);
	VertexOutputBaseSimple o;
	UNITY_INITIALIZE_OUTPUT(VertexOutputBaseSimple, o);
...
half4 fragForwardBaseSimpleInternalFur(VertexOutputBaseSimple i, half FUR_OFFSET)
{
	UNITY_APPLY_DITHER_CROSSFADE(i.pos.xy);
	...
	/*return OutputForward(half4(c, 1), s.alpha * alpha);*/
	return OutputForward(half4(c, alpha), s.alpha);
}
